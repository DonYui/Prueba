...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Crear dots si existen los elementos
  if (carouselDots && testimonialText) {
    ...
    constructor() {
      ...
      this.industriesData = [
        ...
        },
        {
          ...
          title: "Retail",
          description: "Implementación de los módulos de procure to pay y SCM.",
        ...
        },
        {
          ...
          title: "Servicios",
          description: "Implementación de los módulos de order to cash, procure to pay y SCM.",
  ...
  if (document.getElementById('infiniteCarouselTrack')) {
